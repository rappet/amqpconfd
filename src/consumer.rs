...
use lapin::options::{BasicAckOptions, BasicConsumeOptions, QueueDeclareOptions, BasicNackOptions};
...
impl ConfigChangeConsumer {
    ...
    pub async fn connect(uri: &str) -> anyhow::Result<ConfigChangeConsumer> {
        let connection =
